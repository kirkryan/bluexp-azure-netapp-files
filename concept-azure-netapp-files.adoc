...
+
https://docs.netapp.com/us-en/cloud-manager-sync/concept-cloud-sync.html[Learn more about BlueXP copy and sync^]
...
+
https://docs.netapp.com/us-en/cloud-manager-data-sense/concept-cloud-compliance.html[Learn more about BlueXP classification^]
...
* https://docs.netapp.com/us-en/cloud-manager-sync/index.html[BlueXP copy and sync documentation^]
